...
fulreg_HCSZ_GICAinit = load(fullfile(HCSZroot,'MMIVA2step_wGICApre','C030_regSite','HCSZMRI_MMIVAfull_w0GICA_C030_results_new_P000_preregSITE.mat'));
...
%fb_icasig_gicainit_01 = fulreg_HCSZ_GICAinit.icasig{1}';%(:,FBind)';

%fb_icasig_ukbinit_02 = fulreg_HCSZ_UKBinit.icasig{2}';%(:,FBind)';
%fb_icasig_gicainit_02 = fulreg_HCSZ_GICAinit.icasig{2}';%(:,FBind)';

%fb_icasig_ukbinit_03 = fulreg_HCSZ_UKBinit.icasig{3}';%(:,FBind)';
%fb_icasig_gicainit_03 = fulreg_HCSZ_GICAinit.icasig{3}';%(:,FBind)';


%cb_icasig_ukbinit_01 = fulreg_HCSZ_UKBinit.icasig{1}';%(:,CBind)';
%cb_icasig_gicainit_01 = fulreg_HCSZ_GICAinit.icasig{1}';%(:,CBind)';

%cb_icasig_ukbinit_02 = fulreg_HCSZ_UKBinit.icasig{2}';%(:,CBind)';
%cb_icasig_gicainit_02 = fulreg_HCSZ_GICAinit.icasig{2}';%(:,CBind)';

%cb_icasig_ukbinit_03 = fulreg_HCSZ_UKBinit.icasig{3}';%(:,CBind)';
%cb_icasig_gicainit_03 = fulreg_HCSZ_GICAinit.icasig{3}';%(:,CBind)';

%mp_icasig_ukbinit_01 = fulreg_HCSZ_UKBinit.icasig{1}';%(:,MPind)';
%mp_icasig_gicainit_01 = fulreg_HCSZ_GICAinit.icasig{1}';%(:,MPind)';

%mp_icasig_ukbinit_02 = fulreg_HCSZ_UKBinit.icasig{2}';%(:,MPind)';
%mp_icasig_gicainit_02 = fulreg_HCSZ_GICAinit.icasig{2}';%(:,MPind)';

%mp_icasig_ukbinit_03 = fulreg_HCSZ_UKBinit.icasig{3}(:,MPind)';
%mp_icasig_gicainit_03 = fulreg_HCSZ_GICAinit.icasig{3}(:,MPind)';

%bs_icasig_ukbinit_01 = fulreg_HCSZ_UKBinit.icasig{1}';%(:,BSind)';
%bs_icasig_gicainit_01 = fulreg_HCSZ_GICAinit.icasig{1}';%(:,BSind)';

%bs_icasig_ukbinit_02 = fulreg_HCSZ_UKBinit.icasig{2}';%(:,BSind)';
%bs_icasig_gicainit_02 = fulreg_HCSZ_GICAinit.icasig{2}';%(:,BSind)';

%bs_icasig_ukbinit_03 = fulreg_HCSZ_UKBinit.icasig{3}';%(:,BSind)';
%bs_icasig_gicainit_03 = fulreg_HCSZ_GICAinit.icasig{3}';%(:,BSind)';
...
% 
% [DEMO0_FBIRN_GICAinit, MULT0_FBIRN_GICAinit, UNI0_FBIRN_GICAinit] = run_model_HCSZ(MODELHCSZ0_fb, 0.01,fb_icasig_gicainit_01(FBfinalloc,:), [], [], 0);
% save FBIRN_GICAinit_preregSite_SMRI_Mancovan  *0_FBIRN_GICAinit
% 
% % ALFF
...
% 
% [DEMO1_FBIRN_GICAinit, MULT1_FBIRN_GICAinit, UNI1_FBIRN_GICAinit] = run_model_HCSZ(MODELHCSZ1_fb, 0.01,fb_icasig_gicainit_02(FBfinalloc,:), [], [], 0);
% save FBIRN_GICAinit_preregSite_ALFF_Mancovan  *1_FBIRN_GICAinit
% 
% % DMRI
...
% 
% [DEMO2_FBIRN_GICAinit, MULT2_FBIRN_GICAinit, UNI2_FBIRN_GICAinit] = run_model_HCSZ(MODELHCSZ2_fb, 0.01,fb_icasig_gicainit_02(FBfinalloc,:), [], [], 0);
% save FBIRN_GICAinit_preregSite_DMRI_Mancovan  *2_FBIRN_GICAinit
% 
% 
% %%  COBRE
% 
...
% 
% [DEMO0_COBRE_GICAinit, MULT0_COBRE_GICAinit, UNI0_COBRE_GICAinit] = run_model_HCSZ(MODELHCSZ0_cb, 0.01,cb_icasig_gicainit_01(CBfinalloc,:), [], [], 0);
% save COBRE_GICAinit_preregSite_SMRI_Mancovan  *0_COBRE_GICAinit
% 
% % ALFF
...
% 
% [DEMO1_COBRE_GICAinit, MULT1_COBRE_GICAinit, UNI1_COBRE_GICAinit] = run_model_HCSZ(MODELHCSZ1_cb, 0.01,cb_icasig_gicainit_02(CBfinalloc,:), [], [], 0);
% save COBRE_GICAinit_preregSite_ALFF_Mancovan  *1_COBRE_GICAinit
% 
% % DMRI
% 
...
% 
% [DEMO2_COBRE_GICAinit, MULT2_COBRE_GICAinit, UNI2_COBRE_GICAinit] = run_model_HCSZ(MODELHCSZ2_cb, 0.01,cb_icasig_gicainit_03(CBfinalloc,:), [], [], 0);
% save COBRE_GICAinit_preregSite_DMRI_Mancovan  *2_COBRE_GICAinit
% 
% %% MPRC
...
% 
% [DEMO0_MPRC_GICAinit, MULT0_MPRC_GICAinit, UNI0_MPRC_GICAinit] = run_model_HCSZ(MODELHCSZ0_mp, 0.01,mp_icasig_gicainit_01(MPfinalloc,:), [], [], 0);
% save MPRC_GICAinit_preregSite_SMRI_Mancovan  *0_MPRC_GICAinit
% 
% % ALFF
...
% 
% [DEMO1_MPRC_GICAinit, MULT1_MPRC_GICAinit, UNI1_MPRC_GICAinit] = run_model_HCSZ(MODELHCSZ1_mp, 0.01,mp_icasig_gicainit_02(MPfinalloc,:), [], [], 0);
% save MPRC_GICAinit_preregSite_ALFF_Mancovan  *1_MPRC_GICAinit
% 
% % DMRI
% 
...
% 
% [DEMO2_MPRC_GICAinit, MULT2_MPRC_GICAinit, UNI2_MPRC_GICAinit] = run_model_HCSZ(MODELHCSZ2_mp, 0.01,mp_icasig_gicainit_03(MPfinalloc,:), [], [], 0);
% save MPRC_GICAinit_preregSite_DMRI_Mancovan  *2_MPRC_GICAinit
% 
% 
% %% BSNIP
% 
...
% 
% [DEMO0_BSNIP_GICAinit, MULT0_BSNIP_GICAinit, UNI0_BSNIP_GICAinit] = run_model_HCSZ(MODELHCSZ0_bs, 0.01,bs_icasig_gicainit_01(BSfinalloc,:), [], [], 0);
% save BSNIP_GICAinit_preregSite_SMRI_Mancovan  *0_BSNIP_GICAinit
% 
% % ALFF
...
% 
% [DEMO1_BSNIP_GICAinit, MULT1_BSNIP_GICAinit, UNI1_BSNIP_GICAinit] = run_model_HCSZ(MODELHCSZ1_bs, 0.01,bs_icasig_gicainit_02(BSfinalloc,:), [], [], 0);
% save BSNIP_GICAinit_preregSite_ALFF_Mancovan  *1_BSNIP_GICAinit
% 
% % DMRI
% 
...
% 
% [DEMO2_BSNIP_GICAinit, MULT2_BSNIP_GICAinit, UNI2_BSNIP_GICAinit] = run_model_HCSZ(MODELHCSZ2_bs, 0.01,bs_icasig_gicainit_03(BSfinalloc,:), [], [], 0);
% save BSNIP_GICAinit_preregSite_DMRI_Mancovan  *2_BSNIP_GICAinit
% %%
% load FBIRN_UKBinit_preregSite_SMRI_Mancovan
% load FBIRN_GICAinit_preregSite_SMRI_Mancovan.mat
% load FBIRN_UKBinit_preregSite_ALFF_Mancovan
% load FBIRN_GICAinit_preregSite_ALFF_Mancovan.mat
% load FBIRN_UKBinit_preregSite_DMRI_Mancovan
% load FBIRN_GICAinit_preregSite_DMRI_Mancovan.mat
% 
% load COBRE_UKBinit_preregSite_SMRI_Mancovan
% load COBRE_GICAinit_preregSite_SMRI_Mancovan.mat
% load COBRE_UKBinit_preregSite_ALFF_Mancovan
% load COBRE_GICAinit_preregSite_ALFF_Mancovan.mat
% load COBRE_UKBinit_preregSite_DMRI_Mancovan
% load COBRE_GICAinit_preregSite_DMRI_Mancovan.mat
% 
% load MPRC_UKBinit_preregSite_SMRI_Mancovan
% load MPRC_GICAinit_preregSite_SMRI_Mancovan.mat
% load MPRC_UKBinit_preregSite_ALFF_Mancovan
% load MPRC_GICAinit_preregSite_ALFF_Mancovan.mat
% load MPRC_UKBinit_preregSite_DMRI_Mancovan
% load MPRC_GICAinit_preregSite_DMRI_Mancovan.mat
% 
% load BSNIP_UKBinit_preregSite_SMRI_Mancovan
% load BSNIP_GICAinit_preregSite_SMRI_Mancovan.mat
% load BSNIP_UKBinit_preregSite_ALFF_Mancovan
% load BSNIP_GICAinit_preregSite_ALFF_Mancovan.mat
% load BSNIP_UKBinit_preregSite_DMRI_Mancovan
% load BSNIP_GICAinit_preregSite_DMRI_Mancovan.mat

%% sex
%SMRI
% [(myFDR(UNI0_FBIRN_GICAinit.p{1} ) <=0.05);(myFDR(UNI0_COBRE_GICAinit.p{1} ) <=0.05); (myFDR(UNI0_MPRC_GICAinit.p{2} ) <=0.05);(myFDR(UNI0_BSNIP_GICAinit.p{1}) <= 0.05)]
% %ALFF
% [(myFDR(UNI1_FBIRN_GICAinit.p{1} ) <=0.05);(myFDR(UNI1_COBRE_GICAinit.p{1} ) <=0.05); (myFDR(UNI1_MPRC_GICAinit.p{3} ) <=0.05);(myFDR(UNI1_BSNIP_GICAinit.p{1}) <= 0.05)]
% %DMRI
% [(myFDR(UNI2_FBIRN_GICAinit.p{1} ) <=0.05);(myFDR(UNI2_COBRE_GICAinit.p{1} ) <=0.05); (myFDR(UNI2_MPRC_GICAinit.p{2} ) <=0.05);(myFDR(UNI2_BSNIP_GICAinit.p{1}) <= 0.05)]
% 
% sum([(myFDR(UNI0_FBIRN_GICAinit.p{1} ) <=0.05);(myFDR(UNI0_COBRE_GICAinit.p{1} ) <=0.05); (myFDR(UNI0_MPRC_GICAinit.p{2} ) <=0.05);(myFDR(UNI0_BSNIP_GICAinit.p{1}) <= 0.05)])
% %ALFF
% sum([(myFDR(UNI1_FBIRN_GICAinit.p{1} ) <=0.05);(myFDR(UNI1_COBRE_GICAinit.p{1} ) <=0.05); (myFDR(UNI1_MPRC_GICAinit.p{3} ) <=0.05);(myFDR(UNI1_BSNIP_GICAinit.p{1}) <= 0.05)])
% %DMRI
% sum([(myFDR(UNI2_FBIRN_GICAinit.p{1} ) <=0.05);(myFDR(UNI2_COBRE_GICAinit.p{1} ) <=0.05); (myFDR(UNI2_MPRC_GICAinit.p{2} ) <=0.05);(myFDR(UNI2_BSNIP_GICAinit.p{1}) <= 0.05)]) 
% 
% %% age 
% sum([(myFDR(UNI0_FBIRN_GICAinit.p{4} ) <=0.05);(myFDR(UNI0_COBRE_GICAinit.p{3} ) <=0.05); (myFDR(UNI0_MPRC_GICAinit.p{3} ) <=0.05);(myFDR(UNI0_BSNIP_GICAinit.p{4}) <= 0.05)])
% %ALFF
% sum([(myFDR(UNI1_FBIRN_GICAinit.p{4} ) <=0.05);(myFDR(UNI1_COBRE_GICAinit.p{3} ) <=0.05); (myFDR(UNI1_MPRC_GICAinit.p{4} ) <=0.05);(myFDR(UNI1_BSNIP_GICAinit.p{4}) <= 0.05)])
% %DMRI
% sum([(myFDR(UNI2_FBIRN_GICAinit.p{4} ) <=0.05);(myFDR(UNI2_COBRE_GICAinit.p{2} ) <=0.05); (myFDR(UNI2_MPRC_GICAinit.p{3} ) <=0.05);(myFDR(UNI2_BSNIP_GICAinit.p{3}) <= 0.05)])



%%
% pVec = (UNI0_BSNIP_GICAinit.p{3}(:));
% pVecF = myFDR(pVec);
% pVecF = reshape(pVecF,36,20);
% sigI=find(pVecF<=0.05);
% [i1,i2]= ind2sub(size(pVecF),sigI);
% 
% sigContr_Diag_BSNIP_GICAinit = UNI0_BSNIP_GICAinit.stats{3}.Contrast(unique(i1));
% 
% %%
...
% %%
% sigIDb = find(myFDR(UNI1_BSNIP_GICAinit.p{3}(:))<=0.05);
% [i1b,i2b] = ind2sub(size(UNI1_BSNIP_GICAinit.p{3}),sigIDb);
% 
% [num2str(UNI1_BSNIP_GICAinit.p{3},'%1.4g') repmat(' ',36,1) strvcat(UNI1_BSNIP_GICAinit.stats{3}.Contrast')]
...
Y0_prereg_gicainit = fulreg_HCSZ_GICAinit.icasig{1}';
%Y0_prereg_ukbinit = fulreg_HCSZ_UKBinit.icasig{1}';


Y0_prereg_gicainit = Y0_prereg_gicainit(keepID,:);
...
[DEMO0_All_preregSite_GICAinit, MULT0_All_preregSite_GICAinit, UNI0_All_preregSite_GICAinit] = run_model_HCSZ(NMODELHCSZ0ns, 0.01,Y0_prereg_gicainit, [], [], 0);
save mancovaOuts_allHCSZ_combinedRelatives_preregSite_C30_SMRI_GICAinit *0_All_preregSite_GICAinit  NMODELHCSZ0ns
...
[DEMO0_AllwX_preregSite_GICAinit, MULT0_AllwX_preregSite_GICAinit, UNI0_AllwX_preregSite_GICAinit] = run_model_HCSZ_withX(NMODELHCSZ0ns, 0.01,Y0_prereg_gicainit, [], [], 0);
save mancovaOuts_allHCSZ_combinedRelatives_wX_preregSite_C30_SMRI_GICAinit *0_AllwX_preregSite_GICAinit NMODELHCSZ0ns
...
%%
Y1_prereg_gicainit = fulreg_HCSZ_GICAinit.icasig{2}';
%Y1_prereg_ukbinit = fulreg_HCSZ_UKBinit.icasig{2}';
Y1_prereg_gicainit= Y1_prereg_gicainit(keepID,:);
...
[DEMO1_All_preregSite_GICAinit, MULT1_All_preregSite_GICAinit, UNI1_All_preregSite_GICAinit] = run_model_HCSZ(NMODELHCSZ1ns, 0.01,Y1_prereg_gicainit, [], [], 0);
save mancovaOuts_allHCSZ_combinedRelatives_preregSite_C30_ALFF_GICAinit *1_All_preregSite_GICAinit
...
[DEMO1_AllwX_preregSite_GICAinit, MULT1_AllwX_preregSite_GICAinit, UNI1_AllwX_preregSite_GICAinit] = run_model_HCSZ_withX(NMODELHCSZ1ns, 0.01,Y1_prereg_gicainit, [], [], 0);
save mancovaOuts_allHCSZ_combinedRelatives_wX_preregSite_C30_ALFF_GICAinit *1_AllwX_preregSite_GICAinit
...
%%
Y2_prereg_gicainit = fulreg_HCSZ_GICAinit.icasig{3}';
%Y2_prereg_ukbinit = fulreg_HCSZ_UKBinit.icasig{3}';
Y2_prereg_gicainit= Y2_prereg_gicainit(keepID,:);
...
[DEMO2_All_preregSite_GICAinit, MULT2_All_preregSite_GICAinit, UNI2_All_preregSite_GICAinit] = run_model_HCSZ(NMODELHCSZ2ns, 0.01,Y2_prereg_gicainit, [], [], 0);
save mancovaOuts_allHCSZ_combinedRelatives_preregSite_C30_DMRI_GICAinit *2_All_preregSite_GICAinit
...
[DEMO2_AllwX_preregSite_GICAinit, MULT2_AllwX_preregSite_GICAinit, UNI2_AllwX_preregSite_GICAinit] = run_model_HCSZ_withX(NMODELHCSZ2ns, 0.01,Y2_prereg_gicainit, [], [], 0);
save mancovaOuts_allHCSZ_combinedRelatives_wX_preregSite_C30_DMRI_GICAinit *2_AllwX_preregSite_GICAinit


%%
% SMRI
[sx00_comp,sx00_T,sx00_contr]= printouts(UNI0_AllwX_preregSite_GICAinit,1);
[d00_comp,d00_T,d00_contr]= printouts(UNI0_AllwX_preregSite_GICAinit,2);
[a00_comp,a00_T,a00_contr] = printouts(UNI0_AllwX_preregSite_GICAinit,3);
%[rsn00_comp,rsn00_T,rsn00_contr]=printouts(UNI0_AllwX_preregSite_GICAinit,5);
[sxd00_comp,sxd00_T,sxd00_contr]=printouts(UNI0_AllwX_preregSite_GICAinit,4);

% ALFF
%[sx11_comp,sx11_T,sx11_contr]=printouts(UNI1_AllwX_preregSite_GICAinit,1);
[d11_comp,d11_T,d11_contr]= printouts(UNI1_AllwX_preregSite_GICAinit,1);
%[st11_comp,st11_T,st11_contr]= printouts(UNI1_AllwX_preregSite_GICAinit,3);
[a11_comp,a11_T,a11_contr] = printouts(UNI1_AllwX_preregSite_GICAinit,2);
[rsn11_comp,rsn11_T,rsn11_contr]=printouts(UNI1_AllwX_preregSite_GICAinit,3);
[rfd11_comp,rfd11_T,rfd11_contr]=printouts(UNI1_AllwX_preregSite_GICAinit,4);
%[sxd11_comp,sxd11_T,sxd11_contr]=printouts(UNI1_AllwX_preregSite_GICAinit,6);


% DMRI
[sx22_comp,sx22_T,sx22_contr]=printouts(UNI2_AllwX_preregSite_GICAinit,1);
[d22_comp,d22_T,d22_contr]= printouts(UNI2_AllwX_preregSite_GICAinit,2);
%[st22_comp,st22_T,st22_contr]= printouts(UNI2_AllwX_preregSite_GICAinit,3);
[a22_comp,a22_T,a22_contr] = printouts(UNI2_AllwX_preregSite_GICAinit,3);
%[rsn22_comp,rsn22_T,rsn22_contr]=printouts(UNI2_AllwX_preregSite_GICAinit,5);
[sxd22_comp,sxd22_T,sxd22_contr]=printouts(UNI2_AllwX_preregSite_GICAinit,4);
%[axd22_comp,axd22_T,axd22_contr]=printouts(UNI2_AllwX_preregSite_GICAinit,5);
%%
aa{1} = UNI0_AllwX_preregSite_GICAinit;
aa{2} = UNI1_AllwX_preregSite_GICAinit;
aa{3} = UNI2_AllwX_preregSite_GICAinit;
%
dm{1} = DEMO0_All_preregSite_GICAinit;
dm{2} = DEMO1_All_preregSite_GICAinit;
dm{3} = DEMO2_All_preregSite_GICAinit;
%%
...
plotuni(aa,dm,1,'age',a00_contr,a00_comp,a00_T)
plotuni(aa,dm,2,'age',a11_contr,a11_comp,a11_T)
plotuni(aa,dm,3,'age',a22_contr,a22_comp,a22_T)

plotuni(aa,dm,1,'diagnosis',d00_contr,d00_comp,d00_T)
plotuni(aa,dm,2,'diagnosis',d11_contr,d11_comp,d11_T)
plotuni(aa,dm,3,'diagnosis',d22_contr,d22_comp,d22_T)

plotuni(aa,dm,2,'rSN_ALFF',rsn11_contr,rsn11_comp,rsn11_T)
%%
...
%%
atrm = 'age';
ageCol = find(contains(DEMO0_AllwXpreregSite_GICAinit.names,atrm)>0);
Age = DEMO0_AllwXpreregSite_GICAinit.full(:,ageCol);
cmAge = vals2colormap(Age,'jet',[min(Age) max(Age)]);
alocs0 = find(contains(UNI0_AllwXpreregSite_GICAinit.tests,atrm)>0);
alocs1 = find(contains(UNI1_AllwX_preregSite_GICAinit.tests,atrm)>0);
alocs2 = find(contains(UNI2_AllwX_preregSite_GICAinit.tests,atrm)>0);
% ag
agsig  = [(myFDR(UNI0_AllwXpreregSite_GICAinit.p{alocs0(1)} ) <=0.05);(myFDR(UNI1_AllwX_preregSite_GICAinit.p{alocs1(1)} ) <=0.05); (myFDR(UNI2_AllwX_preregSite_GICAinit.p{alocs2(1)} ) <=0.05)];
agsigID = find(sum(agsig)==3);
tmpp = [myFDR(UNI0_AllwXpreregSite_GICAinit.p{alocs0(1)} );myFDR(UNI1_AllwX_preregSite_GICAinit.p{alocs1(1)} );myFDR(UNI2_AllwX_preregSite_GICAinit.p{alocs2(1)} )];
...
for ii = 1:length(agsigID)
    figure('color',[1 1 1]);
    cc = agsigID(ii);
    scatter3(Y0_prereg_gicainit(:,cc),Y1_prereg_gicainit(:,cc),Y2_prereg_gicainit(:,cc),[],cmAge);    
    view([30 10]);
    ...
    export_fig('UKBicasig_full_prereg_GICAinit_C30_bysigfdrAge.pdf','-append',gcf);
    close all;
end
...
Tage_sigInd = [UNI0_AllwX_preregSite_GICAinit.t{3}(ageSigInd);UNI1_AllwX_preregSite_GICAinit.t{2}(ageSigInd);UNI2_AllwX_preregSite_GICAinit.t{3}(ageSigInd)]
...
sloc = find(contains(DEMO0_AllwX_preregSite_GICAinit.names,'sex')>0);
x0id = find(DEMO0_AllwX_preregSite_GICAinit.full(:,sloc) == 0); % male
x1id = find(DEMO0_AllwX_preregSite_GICAinit.full(:,sloc) == 1); % male

figure('color',[1 1 1]);
for ii = 1:length(sxsigID)
    cc = sxsigID(ii);
    scatter3(Y0_prereg_gicainit(x0id,cc),Y1_prereg_gicainit(x0id,cc),Y2_prereg_gicainit(x0id,cc),[],cmAge(x0id,:));
    hold on;
    scatter3(Y0_prereg_gicainit(x1id,cc),Y1_prereg_gicainit(x1id,cc),Y2_prereg_gicainit(x1id,cc),[],cmAge(x1id,:),'x');
    view([30 10]);
    xlabel('SMRI');ylabel('ALFF');zlabel('DMRI');
    title(['Comp ' my_pad(cc,2)]);
...
pp0 = UNI0_AllwXpreregSite_GICAinit.p{locs0(2)};
pp1 = UNI1_AllwXpreregSite_GICAinit.p{locs1(2)};
pp2 = UNI2_AllwXpreregSite_GICAinit.p{locs2(2)};
pp0f = reshape(myFDR(pp0(:)),size(pp0));
pp1f = reshape(myFDR(pp1(:)),size(pp1));
pp2f = reshape(myFDR(pp2(:)),size(pp2));

[(myFDR(UNI0_AllwXpreregSite_GICAinit.p{locs0(2)} ) <=0.05);(myFDR(UNI1_AllwXpreregSite_GICAinit.p{locs1(2)} ) <=0.05); (myFDR(UNI2_AllwXpreregSite_GICAinit.p{locs2(2)} ) <=0.05)]

%%

%% age 
ageVar = 'age';
tta1=find(strcmp(ageVar ,UNI0_AllwX_preregSite_GICAinit.tests));
tta2=find(strcmp(ageVar ,UNI1_AllwX_preregSite_GICAinit.tests));
tta3 = find(strcmp(ageVar ,UNI2_AllwX_preregSite_GICAinit.tests));

[myFDR(UNI0_AllwX_preregSite_GICAinit.p{tta1}) <= 0.05;myFDR(UNI1_AllwX_preregSite_GICAinit.p{tta2}) <= 0.05;myFDR(UNI2_AllwX_preregSite_GICAinit.p{tta3}) <= 0.05]
sigCompAGEfdr = find(sum([myFDR(UNI0_AllwX_preregSite_GICAinit.p{tta1}) <= 0.05;myFDR(UNI1_AllwX_preregSite_GICAinit.p{tta2}) <= 0.05;myFDR(UNI2_AllwX_preregSite_GICAinit.p{tta3}) <= 0.05])==3);
sigCompAGEbf = find(sum([(UNI0_AllwX_preregSite_GICAinit.p{tta1}) <= 0.05/20;(UNI1_AllwX_preregSite_GICAinit.p{tta2}) <= 0.05/20;(UNI2_AllwX_preregSite_GICAinit.p{tta3}) <= 0.05/20])==3);
%%
ageloc = find(contains(DEMO0_AllwX_preregSite_GICAinit.names,'age')>0);
sexloc = find(contains(DEMO0_AllwX_preregSite_GICAinit.names,'sex')>0);
if any(ageloc)
    ageloc = ageloc(1);
end
if any(sexloc)
...
Age = DEMO0_AllwX_preregSite_GICAinit.full(:,ageCol);
cmAge = vals2colormap(Age,'jet',[min(Age) max(Age)]);

sex = DEMO0_AllwX_preregSite_GICAinit.full(:,sexCol);
...
for cc= sigCompAGEfdr % [1 2 5 6 8 9 13 19]
    ...
    scatter3(Y0_prereg_gicainit(x0id,cc),Y1_prereg_gicainit(x0id,cc),Y2_prereg_gicainit(x0id,cc),[],cmAge(x0id,:));
    hold on;
    scatter3(Y0_prereg_gicainit(x1id,cc),Y1_prereg_gicainit(x1id,cc),Y2_prereg_gicainit(x1id,cc),[],cmAge(x1id,:),'filled');
    view([30 10]);
    xlabel('SMRI');ylabel('ALFF');zlabel('DMRI');
    title(['Comp ' my_pad(cc,2)]);
    ...
    %set(cb,'FontName','Arial')
    set(gca,'FontName','Arial')
    export_fig('HCSZ_icasig_full_GICAinit_regsite_C30_bysigfdrAge.pdf','-append',gcf);
    close all;
end
...
% SMRI
psigID = reshape(myFDR(UNI0_AllwXpreregSite_GICAinit.p{2}(:)) <=0.05,size(UNI0_AllwXpreregSite_GICAinit.p{2}));
for rr=1:45
    sigc = find(psigID(rr,:)==1);
    if any(sigc)
        disp([UNI0_AllwXpreregSite_GICAinit.stats{2}.Contrast{rr} ': ' num2str(sigc.*sign(UNI0_AllwXpreregSite_GICAinit.t{2}(sigc)) )]);
    end
end
%%
...
% sigInd_diag_all_GICAinit_SMRI = find(myFDR(UNI0_AllpreregSite_GICAinit.p{1}(:))<=0.05);
% [i0_1g,i0_2g] = ind2sub(size(UNI0_AllpreregSite_GICAinit.p{1}),sigInd_diag_all_GICAinit_SMRI);
% 
...
%         jj=1;
%     end
%     contr =  UNI0_AllpreregSite_GICAinit.stats{1}.Contrast(i0_1g(ii));
%     contr = contr{1};
...
%    figure('color',[1 1 1]); boxplot([Y0_gicainit(id1,comp);Y0_gicainit(id2,comp)],[zeros(length(id1),1);ones(length(id2),1)],'notch','on','labels' ,{lab1 lab2});title(['Comp ' my_pad(comp,2)])
%    export_fig('HCSZicasig_full_GICAinit_preregSite_C30_sigDiag.pdf','-append',gcf);close(gcf)
% end
...
% %% with interaction
% 
% sigInd_diag_allwX_GICAinit_SMRI = find(myFDR(UNI0_AllwXpreregSite_GICAinit.p{2}(:))<=0.05);
% [i0x_1g,i0x_2g] = ind2sub(size(UNI0_AllwXpreregSite_GICAinit.p{2}),sigInd_diag_allwX_GICAinit_SMRI);
% for ii=1:length(i0x_1g)
%     if mod(ii,24)==1
%         figure('color',[1 1 1]);
%         jj=1;
%     end
%     contr =  UNI0_AllwXpreregSite_GICAinit.stats{2}.Contrast(i0x_1g(ii));
%     contr = contr{1};
%     labst = strfind(contr,'(');labnd = strfind(contr,')');
%     lab1 = contr(labst(1)+1:labnd(1)-1);lab2 = contr(labst(2)+1:labnd(2)-1);
%     l1ind = find(strcmp(lab1,MODELHCSZ0ns.labels{3}));    
...
%     id1 = find(MODELHCSZ0ns.X(:,3)== l1ind-1);id2 = find(MODELHCSZ0ns.X(:,3)== l2ind-1);
%    figure('color',[1 1 1]); boxplot([Y0_gicainit(id1,comp);Y0_gicainit(id2,comp)],[zeros(length(id1),1);ones(length(id2),1)],'notch','on','labels' ,{lab1 lab2});title(['Comp ' my_pad(comp,2)])
%    export_fig('HCSZicasig_full_wX_GICAinit_preregSite_C30_sigDiag_SMRI.pdf','-append',gcf);close(gcf)
% end
% sigInd_diag_allwX_GICAinit_ALFF = find(myFDR(UNI1_AllwX_preregSite_GICAinit.p{2}(:))<=0.05);
% [i1x_1g,i1x_2g] = ind2sub(size(UNI1_AllwX_preregSite_GICAinit.p{2}),sigInd_diag_allwX_GICAinit_ALFF);
% 
...
%         jj=1;
%     end
%     contr =  UNI1_AllwX_preregSite_GICAinit.stats{2}.Contrast(i1x_1g(ii));
%     contr = contr{1};
%     labst = strfind(contr,'(');labnd = strfind(contr,')');
%     lab1 = contr(labst(1)+1:labnd(1)-1);lab2 = contr(labst(2)+1:labnd(2)-1);
...
%    figure('color',[1 1 1]); boxplot([Y1_gicainit(id1,comp);Y1_gicainit(id2,comp)],[zeros(length(id1),1);ones(length(id2),1)],'notch','on','labels' ,{lab1 lab2});title(['Comp ' my_pad(comp,2)])
%    export_fig('HCSZicasig_full_wX_GICAinit_preregSite_C30_sigDiag_ALFF.pdf','-append',gcf);close(gcf)
% end
% 
% 
% 
% sigInd_diag_allwX_GICAinit_DMRI = find(myFDR(UNI2_AllwX_preregSite_GICAinit.p{2}(:))<=0.05);
% [i2x_1g,i2x_2g] = ind2sub(size(UNI2_AllwX_preregSite_GICAinit.p{2}),sigInd_diag_allwX_GICAinit_DMRI);
% for ii=1:length(i2x_1g)
%     if mod(ii,24)==1
%         figure('color',[1 1 1]);
%         jj=1;
%     end
%     contr =  UNI2_AllwX_preregSite_GICAinit.stats{2}.Contrast(i2x_1g(ii));
%     contr = contr{1};
%     labst = strfind(contr,'(');labnd = strfind(contr,')');
%     lab1 = contr(labst(1)+1:labnd(1)-1);lab2 = contr(labst(2)+1:labnd(2)-1);
...
%    figure('color',[1 1 1]); boxplot([Y2_gicainit(id1,comp);Y2_gicainit(id2,comp)],[zeros(length(id1),1);ones(length(id2),1)],'notch','on','labels' ,{lab1 lab2});title(['Comp ' my_pad(comp,2)])
%    export_fig('HCSZicasig_full_wX_GICAinit_preregSite_C30_sigDiag_DMRI.pdf','-append',gcf);close(gcf)
% end
% %%
...
% 
% %%
% sigInd_diag_all_GICAinit_wX_SMRI = find(myFDR(UNI0_AllwXpreregSite_GICAinit.p{1}(:))<=0.05);
% [i00_1g,i00_2g] = ind2sub(size(UNI0_AllwXpreregSite_GICAinit.p{1}),sigInd_diag_all_GICAinit_wX_SMRI);
% 
...
% pAge_210_GICAinit =[myFDR(UNI2_AllwX_preregSite_GICAinit.p{4});myFDR(UNI1_AllwX_preregSite_GICAinit.p{4});myFDR(UNI0_AllwXpreregSite_GICAinit.p{4})];
% 
% pSex_210_GICAinit =[myFDR(UNI2_AllwX_preregSite_GICAinit.p{1});myFDR(UNI1_AllwX_preregSite_GICAinit.p{1});myFDR(UNI0_AllwXpreregSite_GICAinit.p{1})];
% 
% 
% sigIntInd2_sexXdiag_GICAinit = find(myFDR(UNI2_AllwX_preregSite_GICAinit.p{6}(:))<=0.05);
% [ix21g,ix22g] = ind2sub(size(UNI2_AllwX_preregSite_GICAinit.p{6}),sigIntInd2_sexXdiag_GICAinit);
% 
% %%
...
% nC=20;
% for cc=1:nC
% figure('color',[1 1 1]);scatter3(Y0_gicainit(:,cc),Y1_gicainit(:,cc),Y2_gicainit(:,cc),[],cmAge);
% view([30 10]); 
% xlabel('SMRI');ylabel('ALFF');zlabel('DMRI');
% title(['Comp ' my_pad(cc,2)]);
% export_fig('HCSZicasig_full_GICAinit_preregSite_C30_byAge.pdf','-append',gcf);
% close all;
% end
% 
% for cc=1:nC
...
% 
% for cc=1:nC
% figure('color',[1 1 1]);scatter3(Y0_gicainit(:,cc),Y1_gicainit(:,cc),Y2_gicainit(:,cc),[],cmSite);
% view([30 10]); 
% xlabel('SMRI');ylabel('ALFF');zlabel('DMRI');
% title(['Comp ' my_pad(cc,2)]);
% export_fig('HCSZicasig_full_GICAinit_preregSite_C30_bySite.pdf','-append',gcf);
% close all;
% end
% 
% for cc=1:nC
...
% 
% for cc=1:nC
% figure('color',[1 1 1]);scatter3(Y0_gicainit(:,cc),Y1_gicainit(:,cc),Y2_gicainit(:,cc),[],cmDiag);
% view([30 10]); 
% xlabel('SMRI');ylabel('ALFF');zlabel('DMRI');
% title(['Comp ' my_pad(cc,2)]);
% export_fig('HCSZicasig_full_GICAinit_preregSite_C30_byDiag.pdf','-append',gcf);
% close all;
% end
% 
% for cc=1:nC
...
%%
Tage_all = [UNI0_AllwX_preregSite_GICAinit.t{3};UNI1_AllwX_preregSite_GICAinit.t{2};UNI2_AllwX_preregSite_GICAinit.t{3}];
Tage_all_SgnSum =  sum(sign(Tage_all));
signMaps = ones(1,30);
signMaps(Tage_all_SgnSum==3) = -1;
%%
fulreg_HCSZ_GICAinitSgnCor = fulreg_HCSZ_GICAinit;
for mm=1:3,fulreg_HCSZ_GICAinitSgnCor.A_ls1{mm} = bsxfun(@times,fulreg_HCSZ_GICAinitSgnCor.icasig{mm},signMaps');end
for mm=1:3,fulreg_HCSZ_GICAinitSgnCor.A_ls1{mm} = bsxfun(@times,fulreg_HCSZ_GICAinit.A_ls1{mm},signMaps);end
for mm=1:3,fulreg_HCSZ_GICAinitSgnCor.A_ls1_ox{mm} = bsxfun(@times,fulreg_HCSZ_GICAinit.A_ls1_ox{mm},signMaps);end
for mm=1:3,fulreg_HCSZ_GICAinitSgnCor.A_ls2{mm} = bsxfun(@times,fulreg_HCSZ_GICAinit.A_ls2{mm},signMaps);end
for mm=1:3,fulreg_HCSZ_GICAinitSgnCor.A_ls2_ox{mm} = bsxfun(@times,fulreg_HCSZ_GICAinit.A_ls2_ox{mm},signMaps);end
for mm=1:3,fulreg_HCSZ_GICAinitSgnCor.A_pinv{mm} = bsxfun(@times,fulreg_HCSZ_GICAinit.A_pinv{mm},signMaps);end
for mm=1:3,fulreg_HCSZ_GICAinitSgnCor.A_tr{mm} = bsxfun(@times,fulreg_HCSZ_GICAinit.A_tr{mm},signMaps);end
for mm=1:3,fulreg_HCSZ_GICAinitSgnCor.W{mm} = bsxfun(@times,fulreg_HCSZ_GICAinit.W{mm},signMaps');end
save HCSZMRI_MMIVAfull_w0GICA_C020_results_new_P000_preregSITE_signCorrected fulreg_HCSZ_GICAinitSgnCor
%%
Y0_prereg_gicainit_sgnCor = bsxfun(@times,Y0_prereg_gicainit,signMaps);
Y1_prereg_gicainit_sgnCor = bsxfun(@times,Y1_prereg_gicainit,signMaps);
Y2_prereg_gicainit_sgnCor = bsxfun(@times,Y2_prereg_gicainit,signMaps);
...
for cc= sigCompAGEfdr % [1 2 5 6 8 9 13 19]
    figure('color',[1 1 1]);
    %scatter3(Yful_SMRI(cc,:)',Yful_ALFF(cc,:)',Yful_DMRI(cc,:)',[],cmAge);
    scatter3(Y0_prereg_gicainit_sgnCor(x0id,cc),Y1_prereg_gicainit_sgnCor(x0id,cc),Y2_prereg_gicainit_sgnCor(x0id,cc),[],cmAge(x0id,:));
    hold on;
    scatter3(Y0_prereg_gicainit_sgnCor(x1id,cc),Y1_prereg_gicainit_sgnCor(x1id,cc),Y2_prereg_gicainit_sgnCor(x1id,cc),[],cmAge(x1id,:),'filled');
    view([30 10]);
    xlabel('SMRI');ylabel('ALFF');zlabel('DMRI');
    title(['Comp ' my_pad(cc,2)]);
    ...
    %set(cb,'FontName','Arial')
    set(gca,'FontName','Arial')
    export_fig('HCSZ_icasig_full_GICAinit_regsite_C30_bysigfdrAge_sgnCor.pdf','-append',gcf);
    close all;
end
%%
for cc = 20
    figure('color',[1 1 1]); 
    %scatter3(Y0_prereg_gicainit_sgnCor(HCid,cc),Y1_prereg_gicainit_sgnCor(HCid,cc),Y2_prereg_gicainit_sgnCor(HCid,cc),[],'b');%cmAge(HCid,:));
    %hold on;
    scatter3(Y0_prereg_gicainit_sgnCor(SZid,cc),Y1_prereg_gicainit_sgnCor(SZid,cc),Y2_prereg_gicainit_sgnCor(SZid,cc),[],'r');%cmAge(x1id,:),'x');
    hold on;
    scatter3(Y0_prereg_gicainit_sgnCor(BPid,cc),Y1_prereg_gicainit_sgnCor(BPid,cc),Y2_prereg_gicainit_sgnCor(BPid,cc),[],'g');
    view([30 10]);
    xlabel('SMRI');ylabel('ALFF');zlabel('DMRI');
    title(['Comp ' my_pad(cc,2)]);
...
%%
odir ='/media/eswar/New Volume/Documents/MISA/HCSZ/MMIVA2step_wGICApre/C030_regSite/figs/stats_png'; 
