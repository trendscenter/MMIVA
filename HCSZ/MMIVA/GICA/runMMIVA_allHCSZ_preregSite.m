...
colorbar; colormap(hot); axis equal tight
saveas(gcf,fullfile(outpath,sprintf('C%03d_GICAcorr_Infomax_vs_MISA_P%03d_preregSITE.png',comps,P)))
...
axis equal tight
saveas(gcf,fullfile(outpath,sprintf('C%03d_mmiva1_corr_P%03d_preregSITE.png',comps,P)))
...
axis equal tight
saveas(gcf,fullfile(outpath,sprintf('C%03d_mmgica1_corr_P%03d_preregSITE.png',comps,P)))
...
colorbar; colormap(hot); axis equal tight
saveas(gcf,fullfile(outpath,sprintf('C%03d_mmgica1_vs_mmiva1_P%03d_preregSITE.png',comps,P)))
...
fname = sprintf('HCSZMRI_MMIVAreduced_w0GICA_C%03d_results_new_P%03d_preregSITE',step3_reduced.C(1),P);
...
fname = sprintf('HCSZMRI_MMIVAfull_w0GICA_C%03d_results_new_P%03d_preregSITE',step3_full.C(1),P);
save(fullfile(outpath,[fname '.mat']), ...
