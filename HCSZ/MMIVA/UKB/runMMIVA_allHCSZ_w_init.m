...
initpath=fullfile('/data/users2/eswar/temp/MISA_analysis/UKB/','results','hyb_','MISA2step');
...
save keepID_HCSZ keepID_*  *finalloc *finalind
%%
...
ful20 = load(fullfile(initpath,'UKBMRI_MMIVAfull_w0GICA_C020_results_goodSub3497_new_P000.mat'));
Winit = ful20.W;
clear ful20;
...
fname = sprintf('HCSZMRI_MMIVAfull_w0UKBinit_C%03d_results_new_P%03d',step3_full.C(1),P);
save(fullfile(outpath,[fname '.mat']), ...
